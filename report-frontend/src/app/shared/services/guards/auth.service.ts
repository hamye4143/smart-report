...
export class AuthService {
  ...
  private signup_url: string = 'http://localhost:5000/signup';
  private logout_url: string = 'http://localhost:5000/logout';
  private get_board_writer: string = 'http://localhost:5000/blog/';
  private change_info_url: string = 'http://localhost:5000/change_info/';
  private change_name_url: string = 'http://localhost:5000/change_name/';
